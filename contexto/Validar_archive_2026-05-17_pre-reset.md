...
- `[ ]` **Device físico Samsung S25 Ultra** — validar:
  - `[x]` Alarme NÃO mostra "Sem paciente" mais — confirmado lhenrique.pda 2026-05-17 com paciente "Dona Maria".
  - `[x]` Pull-to-refresh Dashboard remove paciente compartilhado + doses fantasma após owner revogar share — confirmado lhenrique.pda 2026-05-17.
  - `[~]` Unshare em background: app caregiver killed quando owner revoga share — cache LIMPO (paciente sumiu pós-Dashboard+volta) ✅ MAS UX falhou: app abriu sozinho + tela "Paciente Carregando..." travada. Bugs #298a (startActivity intrusivo) + #298b (__dosyPendingPatientId conflict) ROADMAP §3.
...
- `[x]` **Device físico Samsung S25 Ultra** — confirmado lhenrique.pda 2026-05-17: cuidador com app fechado (swipe-kill) recebeu alarme com som no horário exato.
