...
> **Última revisão:** 2026-05-05 — pós release v0.2.0.9 (versionCode 42 / versionName 0.2.0.9). Master sincronizado, sem release branch ativa.
...
**Deploy Android (Play Store):** **Internal Testing ativo** — `com.dosyapp.dosy` versionCode 42 / versionName 0.2.0.9. Closed Testing externo via Google Group #129-#133 pendente. BUG-016 fechado 100%; #084-#095 fechados v0.1.7.x; redesign v0.2.0.0; #099-#123 + #126 fechados em v0.2.0.1-v0.2.0.5; #010 + #017 fechados v0.2.0.6; v0.2.0.7 FLAG_SECURE off Dev + StatusBar tema; v0.2.0.8 P0 egress fixes #127 + #134-#136 + assets store + vídeo FGS + auditoria egress; v0.2.0.9 P1 egress fixes #137 (Dashboard 4→1) + #138 (DOSE_COLS_LIST) + #128 (patientName Edge) + filter '10 dias'.
