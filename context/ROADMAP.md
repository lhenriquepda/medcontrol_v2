...
**release/v0.2.3.14 SHIPPED** (vc 77, 2026-05-19 Internal Testing 10:45 BRT) — 3 fixes P2 user-reported + empilhamento C debugability. Validação web Chrome MCP 5/5 OK, device físico S25 Ultra pendente pós-publish. Próximos passos:
